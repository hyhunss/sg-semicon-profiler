...
- Match all scores, claims, and URLs in the canonical JSON exactly; do not add, omit, or alter decision content. Present every component and total score with its denominator in plain language: `5 out of 5`, not merely `5` or `5/5`.
