...
2. State the SME-level SBF engagement recommendation before the action table: whether to contact SBF, the primary stage to request, the specific request, and any preparation required.
...
- Render each source URL no more than once per finalist in the detailed audit trail, grouping its source-backed claims in one card.
